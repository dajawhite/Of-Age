...
function Hero(){
    ...
    return(
        <div className='relative '>
            {/* Images */}
            {showImages && (
                <div className={`h-screen flex flex-row items-center pt-24 pb-24 justify-center space-x-14 px-10 transition-all duration-1000`}>
            ...
            {showText && (
                <div className={`h-screen flex flex-col items-center pt-28 pb-24 justify-center px-6 transition-all duration-1000 bg-black ${fadeOutText ? 'opacity-0' : ''}`} data-aos="fade-in">
                    <h1 className="text-lg text-center leading-loose text-white">
                    Vibrant blossoms cascade across the horizon's <br/> mosaic labyrinth.
                    </h1>
                </div>
            )}
